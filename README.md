...
```bash
npx -y mottainai@0.8.2 manager
npx -y mottainai@0.8.2 manager --no-open --port 4318
```
...
```bash
npx -y mottainai@0.8.2
```

Claude Code:

```bash
claude mcp add -s user mottainai -- npx -y mottainai@0.8.2 serve --config /absolute/path/to/mottainai.config.json
```

Codex:

```bash
codex mcp add mottainai -- npx -y mottainai@0.8.2 serve --config /absolute/path/to/mottainai.config.json
```
