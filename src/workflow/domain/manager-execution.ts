 ...
 *
 * The current-main adapter below delegates to the existing workflow task
 * boundary.  The Nawabari migration can replace this adapter without changing
 * Manager HTTP, persistence, or Zellij code.
 */
