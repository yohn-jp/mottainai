...
> architecture in [`runtime-architecture.md`](../../architecture/runtime/README.md).
...
See [`runtime-architecture.md`](../../architecture/runtime/README.md) for the authoritative
...
See [`runtime-state.md`](../../contracts/runtime/state.md) for the authoritative ownership and
survival matrix and [`runtime-lifecycle.md`](../../architecture/runtime/lifecycle.md) for
