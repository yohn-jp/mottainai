...
- Live Linux guest contract: [`linux-runtime-contract.md`](linux-runtime-contract.md)
- Desired managed package state: [`managed-package-manifest.md`](managed-package-manifest.md)
- Managed generation projection: [`managed-generation.md`](managed-generation.md)
- Runtime state and persistence: [`runtime-state.md`](runtime-state.md)
- Runtime lifecycle and failure transitions: [`runtime-lifecycle.md`](runtime-lifecycle.md)
