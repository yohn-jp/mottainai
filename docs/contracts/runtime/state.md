...
- [`runtime-architecture.md`](../../architecture/runtime/README.md) — layer ownership and
  rebuild boundaries;
...
- [`runtime-lifecycle.md`](../../architecture/runtime/lifecycle.md) — transitions among the states
  defined here.
